        ...
        <section>
          <section class="tablaPrincipal">
            <table class="default">
              ...
              <tbody>
           <tr v-for="herramienta in filteredList" :key="herramienta.id">
  ...
  export default {
    ...
    data() {
      return {
        ...
        herramientas: [
          { id: 1, marca: 'Makita', modelo: 'ACBC-52', tipo: 'Rotomartillo'},
          { id: 2, marca: 'Bosh', modelo: 'DCL-46', tipo: 'Cierra electrica'},
          { id: 3, marca: 'Truper', modelo: 'PLK09', tipo: 'Taladro'},
          // ...
      ...
      if (this.searchText !== '') {
        list = list.filter(herramienta => {
          ...
          return herramienta.marca.toLowerCase().includes(searchValue)
            ...
            || herramienta.id.toString().toLowerCase().includes(searchValue);
        });
      }
      return list;
    }
